...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'g_comment_heart_scheme',
            'type' => 'select',
            'title' => __('走心区域配色方案', 'kratos'),
            'subtitle' => __('短码 [heart_comments] 和「走心评论」页面模板都会使用此方案。羊皮纸方案带做旧纹理与焦边阴影；其他方案为简洁渐变背景', 'kratos'),
            'options' => array(
                'parchment' => __('羊皮纸', 'kratos'),
                'sakura'    => __('樱花粉', 'kratos'),
                'mint'      => __('薄荷绿', 'kratos'),
                'sky'       => __('天空蓝', 'kratos'),
                'lavender'  => __('薰衣草紫', 'kratos'),
                'sunset'    => __('日落橙', 'kratos'),
            ),
            'default' => 'parchment',
        ),
        array(
