...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('文章无特色图且正文无图时的兜底方式', 'kratos'),
            'options' => array(
        ...
        array(
            ...
            'subtitle' => __('建议不超过 4 个字符', 'kratos'),
            'default' => 'Kratos+',
        ...
        array(
            ...
            'subtitle' => __('仅 Solid 预设生效；其他预设的底色由预设自身控制', 'kratos'),
            'options' => array(
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'number',
            'title' => __('展示条数', 'kratos'),
            'subtitle' => __('建议填列数的整数倍，末行不留空位', 'kratos'),
            'min' => 1,
            'default' => 6,
        ),
        array(
        ...
        array(
            ...
            'subtitle' => __('超出以省略号截断，卡片内最多显示两行', 'kratos'),
            'min' => 5,
            'default' => 20,
        ),
        array(
        ...
        array(
            ...
            'subtitle' => __('开启后不展示管理员账号发出的评论（含回复），只留访客发言', 'kratos'),
        ...
        array(
            ...
            'subtitle' => __('留空则标题卡右侧不显示按钮；可填「走心评论」或「榜首评论人」页面地址', 'kratos'),
            'default' => '',
        ),
