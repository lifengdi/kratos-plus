...
<div class="toolbar clearfix">
	...
	<div class="share float-md-right text-center">
		<?php if (kratos_option('g_donate_fieldset')['g_donate'] ?? false) { ?>
			<a href="javascript:;" id="donate" class="btn btn-donate me-3" role="button"><i class="kicon i-donate"></i> <?php _e('打赏', 'kratos'); ?></a>
		<?php } ?>
		<a href="javascript:;" id="thumbs" data-action="love" data-id="<?php the_ID(); ?>" role="button" class="btn btn-thumbs <?php if (isset($_COOKIE['love_' . $post->ID])) echo 'done'; ?>"><i class="kicon i-like"></i><span class="ms-1"><?php _e('点赞', 'kratos'); ?></span></a>
	</div>
</div>